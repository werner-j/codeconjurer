 ...
 */
public class ActivatorButton implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		if (action.isChecked()) {
			CodeConjurer.getInstance().setBackgroundAgentEnabled(true);
		} else {
