 ...
 * 
 */
public class PerformSearch implements IWorkbenchWindowActionDelegate {

	private Logger logger = Logger.getLogger(PerformSearch.class);

	public PerformSearch() {
		logger.debug("PerformSearch action registered");
	}
